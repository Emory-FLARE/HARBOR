...
class Item():
    def __init__(self, id: int, name: str, price: int, desc: str, true_value: int, ideal_for: str=None, trait: str=None):
        self.id = id
        self.name = name
        self.price = price
        self.desc = desc
    ...
    def get_desc(self):
        return f"{self.name}, {self.desc}, starting at ${int(self.price)}."
